...
#
# Script generated by Vivado on Mon Oct 07 17:44:10 +0900 2024
...
#
# Usage        : SubPS.sh
#                SubPS.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SubPS.sh [-reset_run]
#                SubPS.sh [-reset_log]
#                SubPS.sh [-help]
#
...
# script info
echo -e "SubPS.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SubPS.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot SubPS xil_defaultlib.SubPS xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SubPS -key {Behavioral:sim_1:Functional:SubPS} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SubPS.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SubPS.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SubPS.sh [-help]\n\
Usage: SubPS.sh [-step]\n\
Usage: SubPS.sh [-lib_map_path]\n\
Usage: SubPS.sh [-reset_run]\n\
Usage: SubPS.sh [-reset_log]\n\
Usage: SubPS.sh [-keep_index]\n\
Usage: SubPS.sh [-noclean_files]\n\n\
