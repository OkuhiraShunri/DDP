...
#
# Script generated by Vivado on Wed Oct 09 14:58:58 +0900 2024
...
#
# Usage        : CMEM.sh
#                CMEM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CMEM.sh [-reset_run]
#                CMEM.sh [-reset_log]
#                CMEM.sh [-help]
#
...
# script info
echo -e "CMEM.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CMEM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot CMEM xil_defaultlib.CMEM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim CMEM -key {Behavioral:sim_1:Functional:CMEM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb CMEM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./CMEM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: CMEM.sh [-help]\n\
Usage: CMEM.sh [-step]\n\
Usage: CMEM.sh [-lib_map_path]\n\
Usage: CMEM.sh [-reset_run]\n\
Usage: CMEM.sh [-reset_log]\n\
Usage: CMEM.sh [-keep_index]\n\
Usage: CMEM.sh [-noclean_files]\n\n\
