...
#
# Script generated by Vivado on Mon Oct 07 16:58:21 +0900 2024
...
#
# Usage        : MMRAM.sh
#                MMRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MMRAM.sh [-reset_run]
#                MMRAM.sh [-reset_log]
#                MMRAM.sh [-help]
#
...
# script info
echo -e "MMRAM.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MMRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MMRAM xil_defaultlib.MMRAM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MMRAM -key {Behavioral:sim_1:Functional:MMRAM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MMRAM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MMRAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MMRAM.sh [-help]\n\
Usage: MMRAM.sh [-step]\n\
Usage: MMRAM.sh [-lib_map_path]\n\
Usage: MMRAM.sh [-reset_run]\n\
Usage: MMRAM.sh [-reset_log]\n\
Usage: MMRAM.sh [-keep_index]\n\
Usage: MMRAM.sh [-noclean_files]\n\n\
