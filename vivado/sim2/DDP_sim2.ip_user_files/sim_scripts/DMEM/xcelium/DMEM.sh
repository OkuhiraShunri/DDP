...
#
# Script generated by Vivado on Mon Oct 07 17:13:08 +0900 2024
...
# script info
echo -e "DMEM.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DMEM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DMEM -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DMEM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
