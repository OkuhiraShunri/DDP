...
HD_PWD='C:/Users/OkuhiraShunri/Documents/verilog/DDP/vivado/sim2/DDP_sim2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JOIN_DDP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JOIN_DDP.tcl
