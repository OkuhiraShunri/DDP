...
HD_PWD='C:/Users/OkuhiraShunri/Documents/verilog/DDP/vivado/sim2/DDP_sim2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JOIN_DDP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JOIN_DDP.tcl -notrace
